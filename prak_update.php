...
//$query = "INSERT INTO upload(name, size, type, path, id_tugas) VALUES('$fileName', '$fileSize', '$fileType', '$filePath', '$id_tugas')";
//$query = "INSERT INTO upload(name, size, type, path, id_tugas, id_mhs) VALUES('$fileName', '$fileSize', '$fileType', '$filePath', '$id_tugas', '$id_mhs')";
$query = "UPDATE upload SET name='$fileName', size='$fileSize', type='$fileType', path='$filePath' WHERE id=" .$id_tugas;
...
<div class="container">
    <form id="form_upload" action="prak_update.php" method="post" enctype="multipart/form-data">
