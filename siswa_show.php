...
<div class="section-content">
				<h1 class="section-header">TABEL DATA MAHASISWA</h1>
		</div>
        <?php
        ...
        <table border="1" class="fl-table">
            ...
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    if($row['user'] != "Dosen"){
                        echo "<tr>";
                            echo "<td> <a href='style='text-decoration:none; color: black;'>" . $row['nrp'] . " </a> </td>";
                            echo "<td> <a href='style='color: black; text-decoration:none;'> " . $row['nama'] . " </a> </td>";
                        echo "</tr>";
                    }
                }
            }
