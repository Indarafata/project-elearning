...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="navbar-menu d-flex align-items-center justify-content-between w-100">
                ...
                <?php
                if(!$_SESSION['user_is_logged_in'])
                    echo "<a class='btn' href='login_siswa.php' id='navmenu'>Login</a>";
                else{
                    echo "<a class='btn'  href='logout_siswa.php' id='navmenu'>Logout</a>";
                    echo "<a class='btn'  href='' id='navmenu'>Profile</a>";
                }
                ?>
    ...
    <h1 class="section-header">HALO SELAMAT DATANG DI HALAMAN ADMIN</h1>
</body>
